function [retina_dist_ij,retina_angle_ij,spatial_value_ij,distance_ij] = Calculate_Retina_dist_of_2frame_Noego(Anisotropy,Frame_matrix,tracks_filt)
...
for i = 1 : size(Frame_matrix,1)
    for t = 1 : size(Frame_matrix,2)-1
        ...
        [xij_rel_pre,R_polar_pre] = rotate_to_vhat_i_RT_stable(xyz_t_pre,vhat_i_pre,i);

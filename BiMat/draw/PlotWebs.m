...
classdef PlotWebs < handle;
    ...
    properties
        ...
        font_size            = 14;        % Font size for text labels. Change according to network size.
        colors               = [];       % Colors used for draw modules.
 ...
 %           idx_type = idx_type(idx_rows);
            ...
            if(obj.use_labels)
                ...
                for j = 1:obj.n_cols
                    ...
                    text(obj.pos_x(1,j),0,obj.col_labels{j},'HorizontalAlignment','center','FontSize',obj.font_size,'interpreter',obj.interpreter);% Xiao revised
                end
            else
                set(gca,'xticklabel',[]);
                set(gca,'yticklabel',[]);
        ...
        % names.
            ...
            if(isempty(obj.biweb))
                ...
                for i = 1:obj.n_rows; obj.row_labels{i} = num2str(i); end;%Xiao revised
                for j = 1:obj.n_cols; obj.col_labels{j} = num2str(j); end;%Xiao revised

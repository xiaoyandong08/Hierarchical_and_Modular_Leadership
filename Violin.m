classdef Violin < handle
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            obj.ScatterPlot = ...
                scatter(pos + jitter.*jitterstrength, data,args.PointSize, 'MarkerFaceColor',args.PointColor,'MarkerEdgeColor',args.PointEdgeColor);     
            ...
            obj.MeanPlot = plot(pos+[-1,1].*meanDensityWidth, ...
                                [meanValue, meanValue],'Color',hex2rgb('262626'));
            obj.MeanPlot.LineWidth = 5;
        ...
        function set.PointColor(obj, color)
            %obj.ViolinPlot.FaceColor = color;
            obj.ScatterPlot.MarkerFaceColor = color;
            %obj.MeanPlot.Color = color;
        end
        function set.PointEdgeColor(obj, color)
            %obj.ViolinPlot.FaceColor = color;
            obj.ScatterPlot.MarkerEdgeColor = color;
            %obj.MeanPlot.Color = color;
        end
        function set.PointSize(obj, PointSize)
            obj.ScatterPlot.SizeData = PointSize+1;
        end
    ...
    methods (Access=private)
        function results = checkInputs(obj, data, pos, varargin)
            ...
            p.addParameter('BoxColor', [88 89 91]/255, iscolor);
            ...
            p.addParameter('PointSize', 30, isscalarnumber);
            p.addParameter('PointColor', [0.5 0.5 0.5], iscolor);
            p.addParameter('PointEdgeColor', hex2rgb('262626'), iscolor);
